  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(circle, var(--aura-1, rgba(244, 63, 94, 0.4)) 0%, transparent 70%)' }}
      ></div>
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(circle, var(--aura-2, rgba(6, 182, 212, 0.4)) 0%, transparent 70%)', animationDelay: '2s' }}
      ></div>
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(circle, var(--aura-3, rgba(245, 158, 11, 0.3)) 0%, transparent 70%)', animationDelay: '4s' }}
      ></div>
    </div>
  );
};
